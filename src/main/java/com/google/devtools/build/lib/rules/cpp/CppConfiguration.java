...
public class CppConfiguration extends BuildConfiguration.Fragment {
  ...
  private final List<String> gccPluginCompilerOptions;
  ...
  private final ImmutableList<PathFragment> gccPluginHeaders;
  private final ImmutableList<PathFragment> maoPluginHeaders;
  ...
  protected CppConfiguration(CppConfigurationParameters params)
    ...
    this.gccPluginHeaders = toPathFragmentList(crosstoolTopPathFragment,
        toolchain.getGccPluginHeaderDirectoryList());
    this.maoPluginHeaders = toPathFragmentList(crosstoolTopPathFragment,
        toolchain.getMaoPluginHeaderDirectoryList());
    ...
    this.gccPluginCompilerOptions =
        ImmutableList.copyOf(toolchain.getGccPluginCompilerFlagList());
  ...
  /**
   * Converts a list of Strings into a list of PathFragments.
   */
  private static ImmutableList<PathFragment> toPathFragmentList(
      PathFragment crosstoolTopPathFragment, List<String> list) throws IllegalArgumentException {
    ...
    for (String s : list) {
      ...
      builder.add(crosstoolTopPathFragment.getRelative(path));
    }
  ...
  /**
   * Returns the list of additional compiler flags that are added for cc_plugin
   * rules.
   */
  public List<String> getGccPluginCompilerOptions() {
    return gccPluginCompilerOptions;
  }
  ...
  /**
   * Returns a list of directories as path fragments relative to the execution
   * root which contain the compiler headers needed to build gcc plugins.
   */
  public List<PathFragment> getGccPluginHeaders() {
    return gccPluginHeaders;
  }

  /**
   * Returns a list of directories as path fragments relative to the execution
   * root which contain the compiler headers needed to build mao plugins.
   */
  public List<PathFragment> getMaoPluginHeaders() {
    return maoPluginHeaders;
  }
