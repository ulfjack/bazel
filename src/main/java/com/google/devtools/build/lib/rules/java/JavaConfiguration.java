...
public final class JavaConfiguration extends Fragment {
  ...
  private final ImmutableList<String> defaultJavacFlags;
  private final ImmutableList<String> javacOptionsFromCommandLine;
  private final ImmutableList<String> javacOptionsFromJavabuilder;
  ...
  JavaConfiguration(ImmutableList<String> javacOptsFromJavabuilder,
      ImmutableList<String> javacOptsFromCommandLine, boolean generateJavaDeps,
    ...
    this.javacOptionsFromJavabuilder = javacOptsFromJavabuilder;
    this.javacOptionsFromCommandLine = javacOptsFromCommandLine;
    this.defaultJavacFlags = ImmutableList.<String>builder()
        .addAll(javacOptsFromJavabuilder)
        .addAll(javacOptsFromCommandLine).build();
    ...
    this.cacheKey = Joiner.on(" ").join(defaultJavacFlags);
  }
  ...
  /**
   * @return the javacOptsFromCommandLine
   */
  public ImmutableList<String> getJavacOptionsFromCommandLine() {
    return javacOptionsFromCommandLine;
  }

  /**
   * @return the javacOptsFromJavabuilder
   */
  public ImmutableList<String> getJavacOptionsFromJavabuilder() {
    return javacOptionsFromJavabuilder;
  }
}
