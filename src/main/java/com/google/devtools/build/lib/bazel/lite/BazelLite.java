...
package com.google.devtools.build.lib.bazel.lite;
...
public final class BazelLite {
  ...
  public static final List<Class<? extends BlazeModule>> BAZEL_MODULES =
      ImmutableList.of(
          ...
          com.google.devtools.build.lib.runtime.fetch.FetchModule.class,
          ...
          com.google.devtools.build.lib.bazel.lite.rules.BazelRulesModule.class);
  ...
  private static ImmutableMap<String, String> tryGetBuildInfo() {
    try (InputStream in = BazelLite.class.getResourceAsStream(BUILD_DATA_PROPERTIES)) {
      if (in == null) {
