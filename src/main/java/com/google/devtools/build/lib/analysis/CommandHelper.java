...
public final class CommandHelper {
   ...
   */
  // TODO: I would remove this, but I wonder if something invisible references it.
  @VisibleForTesting
  public static int maxCommandLength = getOsSpecificMaxCommandLength(OS.getCurrent());
   ...
   * [2] https://support.microsoft.com/en-us/kb/830473.
   */
  private static int getOsSpecificMaxCommandLength(OS os) {
  ...
  private static Pair<List<String>, Artifact> buildCommandLineMaybeWithScriptFile(
    ...
    if (command.length() <= getOsSpecificMaxCommandLength(ruleContext.getHostConfiguration().getOS())) {
