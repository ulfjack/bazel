...
public abstract class RepositoryFunction {
  public static final String NEW_LOCAL_REPOSITORY_NAME = "new_local_repository";
  public static final String LOCAL_REPOSITORY_NAME = "local_repository";
  ...
  public static RepositoryDirectoryValue.Builder writeFile(
  ...
  public static void addExternalFilesDependencies(
    ...
    try {
      ...
      if (repositoryPath.segmentCount() > 1) {
        if (rule.getRuleClass().equals(RepositoryFunction.LOCAL_REPOSITORY_NAME)
